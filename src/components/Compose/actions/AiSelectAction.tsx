...
interface AiSelectActionProps extends BaseActionEditorProps {
...
export const AiSelectAction: React.FC<AiSelectActionProps> = ({
  instructionArgs,
  onArgChange,
  validationErrors,
  ...
  return (
    <div className="space-y-3">
      ...
      <Input
        ...
        value={instructionArgs.value as string}
